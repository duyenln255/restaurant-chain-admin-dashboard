...
//   const [customer, setCustomer] = useState<CustomerItem | undefined>();
...
//       setPhone(found.phone?.toString() || '');
//       setGender(found.gender || '');
//       setDate(found.dateOfBirth || '');
//     }
//   }, [id]);
...
//   if (!customer) return <div className="p-4 text-red-500">Customer not found.</div>;
...
//                       />
//                     </label>
//                     <span className="text-sm text-blue-600 font-medium">Upload New Photo</span>
//                   </div>
