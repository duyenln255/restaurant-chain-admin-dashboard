...
import BranchTable from './BranchTable'; // Import CustomerTable thay vì bảng cứng
          ...
          <div className="dashboard-body p-6">
            <div className="max-w-[1140px] mx-auto space-y-4">
              ...
              <div className="flex justify-between items-center">
                <h1 className="text-3xl font-bold text-neutral-800">Branch Lists</h1>
              ...
              {/* Branch Table */}
              <BranchTable items={branchs as BranchItem[]} />
